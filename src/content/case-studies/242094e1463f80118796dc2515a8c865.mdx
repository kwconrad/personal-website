export const frontmatter = {
  id: "01",
  title: "Research: Helping Creative Professionals Showcase Their Value",
  overview:
    "Examines the role of social proof in showcasing creative professionals' value and connecting them with local opportunities.",
  role: "UX Designer",
